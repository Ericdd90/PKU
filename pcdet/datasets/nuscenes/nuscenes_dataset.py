...
from ..nuscenes import nuscenes_utils
import pyquaternion
from pyquaternion import Quaternion


class NuScenesDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None, modality=None):
        root_path = (root_path if root_path is not None else Path(dataset_cfg.DATA_PATH)) / dataset_cfg.VERSION
        super().__init__(
            dataset_cfg=dataset_cfg, class_names=class_names, training=training, root_path=root_path, logger=logger, modality=modality,
        )
        self.infos = []
    ...
    def __getitem__(self, index):
        ...
        #nusc = NuScenesDataset(version=self.dataset_cfg.VERSION, dataroot=str(self.root_path), verbose=True)
